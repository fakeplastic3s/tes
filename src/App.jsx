    ...
    <>
      ...
      <div className="w-full py-24 px-4  bg-slate-50 ">
        ...
        <div className="max-w-[1240px] mx-auto flex flex-wrap gap-10 justify-center items-center py-5">
          <img src="/produk/1.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/2.webp" alt="" className="max-w-[150px] md:max-w-[300px]  rounded-xl" />
          <img src="/produk/3.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/4.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/5.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/6.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/7.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
          <img src="/produk/8.webp" alt="" className="max-w-[150px] md:max-w-[300px] rounded-xl" />
